...
%>
<%String planId=request.getParameter("value"); %><!--获取传的m_planId值 -->
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
  <head>
    <base href="<%=basePath%>">
    
    <title>My JSP 'actplan_talk_shiju.jsp.jsp' starting page</title>
	...
	<script type="text/javascript" src="js/actplan_talk_shiju.js"></script>
  ...
  <body>
     ...
     <div id="back" style="width:100%;height:60%;">
            <hr style="border:1px solid #ADD8E6;margin-top:20px"/>
     ...
     <div   id="talk" style="display: none">
        <table>
	        <tr>
	           <td>
	             <select id="shi" style="width:60px">
	
			     </select>
			   </td>
			   <td>
	             <select id="xian" style="width:60px">
	
			     </select>
			   </td>
			   <td>
	             <select id="ting" style="width:60px">
