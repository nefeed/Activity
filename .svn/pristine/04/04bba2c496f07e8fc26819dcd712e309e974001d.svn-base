...
public class ServletPublishActplan extends HttpServlet{
	...
	public void service(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		String m_receiveAbleId = new String(request.getParameter("m_receive").getBytes("ISO-8859-1"),"utf-8"); //能接单的单位的m_secId
		...
		boolean check = bllInterface.PublishActplan(m_planId,m_createId, m_planName, m_planGoal, m_planContent, m_address,
