...
public class ServletQueryUnPublishActplan extends HttpServlet{
	...
	public void service(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		JSONArray json = JSONArray.fromObject(bllInterface.QueryBySecIdAndUserId(m_secId,m_userId));
		System.out.println("——————————遍历上层公布其能收到的但本局未发布活动信息——————————\n"+json);
