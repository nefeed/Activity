...
<html>
  <head>
	...
	<script type="text/javascript" src="js/businesshall.js"></script>
	    ...
	    <div class="contain">  
	     <div class="left">
	        <div  style="width:225px;height:460px;margin-left:12.5px;">   
                  <div class="view_a">
                     <input type="button" class="btn" value="未发布活动" onclick="businesshall_unpublish()" id="admin"/></div>
                  <div class="view_a">
                     <input type="button" class="btn" value="已发布活动" onclick="businesshall_publish()" id="admin"/></div>
                  <div class="view_a">
                     <input type="button" class="btn" value="下属单位" onclick="subordinate()" id="admin"/></div>
                  <div class="view_a">
                     <input type="button" class="btn" value="增加客户信息" onclick="AddCustomer()" id="admin"/></div>
                  <div class="view_a">
                     <input type="button" class="btn" value="遍历客户信息" onclick="ShowCustomer()" id="admin"/></div>
	    	</div>
	     </div>
	     <div class="right">
	          <div class="inner" >
