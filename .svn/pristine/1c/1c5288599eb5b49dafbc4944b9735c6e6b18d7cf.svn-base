...
<html>
  <head>
    ...
    <title>My JSP 'shiju.jsp' starting page</title>
	...
	<script type="text/javascript" src="js/shiju.js"></script>
	    ...
	    <div class="contain">  
	     <div class="left">
	        <div  style="width:225px;height:460px;margin-left:12.5px;">   
                  <div class="view_a">
                     <input type="button" class="btn" value="未发布活动" onclick="unopen()" id="admin"/></div>
                  <div class="view_a">
                     <input type="button" class="btn" value="已发布活动" onclick="openact()" id="admin"/></div>
                  <div class="view_a">
                     <input type="button" class="btn" value="已结束活动" onclick="end()" id="admin"/></div>
                  <div class="view_a">
                     <input type="button" class="btn" value="下属单位" onclick="showsub_shiju()" id="admin"/></div>
	    	</div>
	     </div>
	     <div class="right">
	          <div class="inner" >
