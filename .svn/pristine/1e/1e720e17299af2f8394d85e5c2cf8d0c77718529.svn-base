...
public class ServletQueryMapping extends HttpServlet{
	...
	public void service(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		JSONArray json = JSONArray.fromObject(bllInterface.QueryMapping(m_planId));
		System.out.println("——————————遍历本活动客户员工对应信息——————————"+json);
