...
public interface BllInterface {
	...
	//省局遍历自己创建的活动
	List<Map<String, Object>> QueryMyActplan(int m_publishId);
	...
	//查询本营业厅所有客户
	List<Map<String, Object>> QueryCustomerBySecId(int m_secId);

	//修改客户状态为1
	boolean DeleteCustomer(int m_cusId);

	//查找本用户创建的最大的活动Id
	int MaxPlanId(int m_userId);
